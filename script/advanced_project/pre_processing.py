...
def advanced_pre_process():
    if os.path.exists('data/_lemmataized/lemmataized_reviews.csv'):
        reviews_df = pd.read_csv('data/_lemmataized/lemmataized_reviews.csv')
        return reviews_df
    ...
    if(os.path.exists('data/_lemmataized/lemmataized_reviews_transformers.csv')):
        reviews_df = pd.read_csv('data/_lemmataized/lemmataized_reviews_transformers.csv')
        return reviews_df
    ...
    # save on csv create folder
    os.makedirs('data/_lemmataized', exist_ok=True)
    reviews_df.to_csv('data/_lemmataized/lemmataized_reviews_transformers.csv', index=False)
    return reviews_df